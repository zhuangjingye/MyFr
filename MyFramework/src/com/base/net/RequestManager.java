...
public class RequestManager {
	 ...
	 * @param request
	 */
	public void requestJSONBy(MyBaseActivity myBaseActivity,final AbstractJsonRequest request) { 
	 ...
	 *
	 */
	public void requestImage(MyBaseActivity myBaseActivity,String url,ImageListener listener) {
		...
		ImageLoader imageLoader = new ImageLoader(myBaseActivity.getRequestQueue(), imageCache);
